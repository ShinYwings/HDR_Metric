function Q = pu21_metric( I_test, I_reference, metric, L_min, L_max, display_model )
...
pu21 = pu21_encoder();
P_test = pu21.encode( L_test , L_min, L_max);
P_reference = pu21.encode( L_reference , L_min, L_max);
