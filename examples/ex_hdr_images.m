...
% Open EXR files through https://github.com/skycaptain/openexr-matlab
I_ref = cv.imread( 'gt0.exr', 'Unchanged');
I_pred = cv.imread('0.exr', 'Unchanged');
L_peak = 10000; % Peak luminance of an HDR display
...
%fprintf( 1, 'Image with mine: PSNR = %g dB, SSIM = %g\n', PSNR_me, SSIM_me );
